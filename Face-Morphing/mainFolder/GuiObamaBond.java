...
public class GuiObamaBond extends JFrame{
	...
	public GuiObamaBond(){
		...
		{		
			...
			Image picture2 = ImageIO.read(new File("C:/Users/Yohanan Ben-Gad/Documents/barakobama.jpg"));
			panel = new JPanel();
			...
			File ImageFile2 = new File("C:/Users/Yohanan Ben-Gad/Documents/barakobama.jpg");
			try {
			...
			for (int i = 0; i < numberPoints-4; i++){
	...
	public void calculate(){
		...
		Graphics graphicso = getGraphics();
		
		/*for (int i = 0; i < 1000; i++){
			for (int j = 0; j < 1000; j++){
				System.out.println(i + " " + j);
				paintComponent(i, j, graphicso, Color.WHITE, 0, 0, 0, 0);
			}
		}*/
		...
		Image picture = null;
		try {
			picture = ImageIO.read(new File("C:/Users/Yohanan Ben-Gad/Documents/barakobama.jpg"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		label1.setBounds(10, 0, icon.getIconWidth(), icon.getIconHeight());
		panely.add(label1);
		//paintComponent(anArray, graphics);
		repaint();
	}
	
	public void paintComponent(int[][] array, Graphics graphicsy){
		for (int i = 0; i < 500; i++){
			for (int j = 0; j < 500; j++){
				
				//int clr1 = array[i][j];
				
				//int  red   = (clr1 & 0x00ff0000) >> 16;
				//int  green = (clr1 & 0x0000ff00) >> 8;
				//int  blue  =  clr1 & 0x000000ff;
				
				graphicsy.setColor(Color.RED);
				graphicsy.drawRect(i, j, 1, 1);
				repaint();
	...
	public void paintComponent(int a, int b, Graphics graphicsy, Color color, int c, int d, int e, int f){
		//super.paintComponents(graphicsy);
		graphicsy.setColor(color);
		graphicsy.drawRect(a, b, 1, 1);
