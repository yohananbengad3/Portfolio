...
#include "graphics/InitShader.h"
#include "graphics/LoadTexture.h"
#include "graphics/LoadMesh.h"

#include "imgui/imgui_impl_glut.h"

#include "utils/VideoMux.h"
#include "utils/DebugCallback.h"
...
static const std::string mesh_name = "textures/grass_low_poly.obj";
static const std::string texture_name = "textures/low_poly_grassDark.png";

//names of the shader files to load
static const std::string vertex_shader("assets/shaders/tfb_vs.glsl");
static const std::string fragment_shader("assets/shaders/tfb_fs.glsl");
